...
<form class="row g-3" action="{{url('/fileUpload')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
        <div class="col-auto">
            ...
            <input type="file" required name="file" class="form-control" id="inputPassword2" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" >
        </div>
        <div class="col-auto">
